...
export default async function AdminLevelEditor({
    ...
    return (
        <div className="px-6 py-8">
            ...
            {/* Top bar: back link left, inspect right */}
            <div className="flex items-center justify-between mb-6">
                <Link
                    href="/admin/levels"
                    className="inline-flex items-center gap-2 text-gray-500 hover:text-black font-bold transition-colors"
                >
                    <ArrowLeft size={20} />
                    Back to Levels
                </Link>
                <a
                    ...
                    target="_blank"
                    className="flex items-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-700 px-3 py-1 rounded-lg text-sm font-bold transition-colors"
                >
                    <span>Inspect</span>
